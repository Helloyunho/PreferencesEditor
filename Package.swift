...
let package = Package(
    ...
    products: [
        ...
        .library(
            name: "PreferencesEditorPreferences",
            targets: ["PreferencesEditorPreferences"]
        ),
    ],
    targets: [
        .target(
            name: "PreferencesEditorC",
            path: "Tweak/Sources/PreferencesEditorC",
            cSettings: [.unsafeFlags(cFlags)],
            cxxSettings: [.unsafeFlags(cxxFlags)]
        ),
        .target(
            name: "PreferencesEditor",
            dependencies: ["PreferencesEditorC"],
            path: "Tweak/Sources/PreferencesEditor",
            swiftSettings: [.unsafeFlags(swiftFlags)]
        ),
        .target(
            name: "PreferencesEditorPreferencesC",
            path: "Preferences/Sources/PreferencesEditorC",
            cSettings: [.unsafeFlags(cFlags)],
            cxxSettings: [.unsafeFlags(cxxFlags)]
        ),
        .target(
            name: "PreferencesEditorPreferences",
            dependencies: ["PreferencesEditorPreferencesC"],
            path: "Preferences/Sources/PreferencesEditor",
            swiftSettings: [.unsafeFlags(swiftFlags)]
        ),
    ]
)
